...
class ListItems(
    ...
    override fun OperationContext.fetchData(): ElementSource<Item> = ElementSource.fromIterable(items)

    override fun OperationContext.createCommand(data: ElementSource<Item>) = {
